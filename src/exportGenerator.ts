...
export function buildDigest(rawNotes: Note[], workspaceRoot: string, now: Date = new Date(), storageDir: string = '.code-notes'): string {
  ...
  // No INDEX.json source pointer here — exports.indexJson can be disabled
  // independently, which would make that claim stale.
  out.push('*Auto-generated by Code Context Notes. Do not edit.*');
  out.push('');
